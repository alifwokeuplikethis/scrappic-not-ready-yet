...
<div style="display:block;margin:auto;"><br/>
   <button class="baten1" style="border-top:none;border-right:none;border-left:none;">Foto yang kamu upload</button>
   <button class="baten2" style="border-top:none;border-right:none;border-left:none;" onclick="window.location.href='savedProfile.php'">Foto yang kamu simpan</button></div>
...
<div class='tile' data-id='".$id."'>
  <img src='img/donwload-logo.png' class='donlod' style='width: 40px;background-color:white;' title='ini download' onclick='downloadImage(".$id.")'><h2 style='position:absolute;top:10px;left:50px;''>".$row["user"]."</h2><img src='img/hapus.png' alt='share icon' style='margin-left: 160px;width:40px;'  title='tekan ini jika ingin menghapus data' id='sher' onclick='hapusData($id)'></img>
