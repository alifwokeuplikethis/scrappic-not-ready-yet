...
if(isset($_POST["submit"])){
    ...
    if(in_array($_FILES["image"]["type"], $allowed_types)) {
        ...
        $kueri = mysqli_query($koneksi, "INSERT INTO images(user,image_data,judul) VALUES('$nama','$imgData','$judul') ");
        if($kueri){
            echo "<script>alert('Gambar berhasil ditambahkan'); window.location.href='index.php';</script>";
            exit;
        } else {
...
<body>
    <div class="container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div>Judul:
            <input type="text" name="judul"  style="width:300px;"required></div>
